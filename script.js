...
export const products = [
  {
    ...
    category: "Birthday",
    price: 60,
    priceFormatted: "60 TK",
    image: "/assets/products/cake.png",
    video: "https://www.youtube.com/watch?v=V_GQbEqU9FY",
    description: "A personalized animated birthday website with cute mascot character, background music, balloon pop surprises, date badge, and floating hearts,cute envelop and letter.",
    badge: "Best Seller",
    rating: 4.9,
    reviewsCount: 284,
    features: ["Custom Photo & Music", "Custom Name and date Display", "Interactive Message Card", "Mobile & Tablet Ready"],
  ...
  },
  {
    ...
    category: "Proposal",
    price: 35,
    priceFormatted: "35 TK",
    image: "/assets/products/Project17 (1).jpg",
    video: "https://www.youtube.com/watch?v=NJnDwPkqscs",
    description: "The interactive proposal website! Features an unclickable runaway 'No' button, sweet kitten mascot, and explosive heart confetti on 'Yes'.",
    badge: "Hot",
    rating: 5.0,
    reviewsCount: 312,
    features: ["Runaway 'No' Button", "Love Confession Reveal", "Romantic Song Player", "little love massage"],
  ...
  },
  {
    ...
    price: 59,
    priceFormatted: "59 TK",
    image: "/assets/products/Project19.jpg",
    video: "https://youtu.be/Lpor_KCB-4E?si=pegllDUp490zxA1l",
    ...
    rating: 4.9,
    reviewsCount: 146,
    features: ["Custom Milestone Timeline", "Days-Together Clock", "Polaroid Photo Frames", "Custom Digital Wax-Seal Letter"],
  ...
  },
  {
    ...
    category: "Romantic",
    price: 29,
    priceFormatted: "29 TK",
    image: "/assets/products/Project21.jpg",
    video: "https://youtu.be/p6ANQnj9jmw?si=tpkiVxFmqYijs2rc",
    description: "A cute I love you animation with name display, and ambient twilight melody.",
    badge: "Editor's Pick",
    rating: 4.7,
    reviewsCount: 98,
    features: ["I Love You Message", "Cute Animation", "Soft Audio Track",],
